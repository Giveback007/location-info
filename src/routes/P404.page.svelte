<script lang="ts">
    import svg404 from "../assets/illustration-404.svg"
</script>
    ...
    <div class="container min-h-screen px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12">
        <div class="wf-ull lg:w-1/2">
            ...
            <div class="flex items-center mt-6 gap-x-3">
                ...
                <button class="w-1/3 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg shrink-0 sm:w-auto hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
                    Take me home
                </button>
            </div>
        </div>
        ...
        <div class="relative w-full mt-12 lg:w-1/2 lg:mt-0">
            <img class="w-full max-w-lg lg:mx-auto" src={svg404} alt="">
        </div>
    </div>
</section>