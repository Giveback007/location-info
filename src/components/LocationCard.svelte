...
<div class="px-8 py-4 mb-1 bg-slate-50 rounded-lg shadow-md dark:bg-gray-800">
    ...
    <div class="mt-2">
        <h1 class="text-xl font-bold text-gray-700 dark:text-white hover:text-gray-600 dark:hover:text-gray-200 hover:underline">{data.fullName}</h1>
