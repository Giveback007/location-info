<script lang="ts">
    ...
    import Squares_2x2 from '../icons/squares-2x2.svelte';
    ...
    currentRoute.subscribe(route => {
        links.map(l => l.isActive = false);

        const lk = (links.find(l => l.href === route) || {} as any);
        lk.isActive = true;
    });
...
<aside class="fixed top-0 z-50 flex">
    <div class="flex flex-col items-center w-16 h-screen py-8 bg-slate-50 border-r dark:bg-gray-900 dark:border-gray-700">
        <nav class="flex flex-col items-center flex-1 space-y-8 ">
            <a href="#">
                ...
                <img class="w-auto h-10 p-1 inline-block transition-colors duration-200 rounded-lg hover:bg-gray-200" src={globWeatherSVG} alt="">
            </a>

            {#each links as link}
                <a href={'#' + link.href} class={`p-1.5 inline-block transition-colors duration-200 rounded-lg ${link.isActive ?
                    'text-blue-500  bg-blue-100 dark:text-blue-400 dark:bg-gray-800'
                    :
                    'text-gray-500 focus:outline-nones dark:text-gray-400 dark:hover:bg-gray-800 hover:bg-gray-200'
                }`}>
        ...
        <div class="flex flex-col items-center mt-4 space-y-4">
            ...
            <a href="#admin" class="p-1.5 inline-block text-gray-500 focus:outline-nones transition-colors duration-200 rounded-lg dark:text-gray-400 dark:hover:bg-gray-800 hover:bg-gray-100">
    ...
    <!-- <div class="h-screen px-5 py-8 overflow-y-auto bg-white border-r sm:w-64 w-60 dark:bg-gray-900 dark:border-gray-700">
        <div class="relative">
